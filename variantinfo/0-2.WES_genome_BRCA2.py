...
#%%
# finaloutput.to_csv('/home/jiye/jiye/copycomparison/variantinfo/withsalvage/depth10/WES_genome_BRCA2.csv', index=False)
...
finaloutput = concatdf
# %%
finaloutput.to_csv('/home/jiye/jiye/copycomparison/variantinfo/modifiedAF/WES_genome_BRCA2.csv', index=False)
