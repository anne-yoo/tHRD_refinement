...
#%%
finaloutput.to_csv('/home/jiye/jiye/copycomparison/variantinfo/modifiedAF/WGS_genome_BRCA1.csv', index=False)

#%%
# finaloutput.to_csv('/home/jiye/jiye/copycomparison/variantinfo/withsalvage/depth10/WGS_genome_BRCA1.csv', index=False)

#%%
#finaloutput.to_csv('/home/jiye/jiye/copycomparison/variantinfo/WGS_genome_BRCA1.csv', index=False)
# %%
