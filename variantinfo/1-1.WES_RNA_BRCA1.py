...
for i in filelist.index:
    try:
        pd.read_csv('~/jiye/copycomparison/newdata/vep_WES_BRCA1/BRCA1-' + filelist.iloc[i,1] + '-vep-filtered0-canonical', sep='\t', header=None, on_bad_lines='skip')
...
#%%
# finaloutput.to_csv('/home/jiye/jiye/copycomparison/variantinfo/withsalvage/depth5/WES_RNA_BRCA1.csv', index=False)

#%%
finaloutput.to_csv('/home/jiye/jiye/copycomparison/variantinfo/modifiedAF/WES_RNA_BRCA1.csv', index=False)
...
#%%
finaloutput.to_csv('/home/jiye/jiye/copycomparison/variantinfo/withsalvage/depth10/WES_RNA_BRCA1.csv', index=False)

#%%
#finaloutput.to_csv('/home/jiye/jiye/copycomparison/variantinfo/WES_RNA_BRCA1.csv', index=False)
# %%
