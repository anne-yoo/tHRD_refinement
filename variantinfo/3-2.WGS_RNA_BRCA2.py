...
for i in filelist.index:
    try:
        pd.read_csv('~/jiye/copycomparison/newdata/vep_WGS_BRCA2/BRCA2-' + filelist.iloc[i,1] + '-vep-filtered0-canonical', sep='\t', header=None, on_bad_lines='skip')
...
#%%
finaloutput.to_csv('/home/jiye/jiye/copycomparison/variantinfo/modifiedAF/WGS_RNA_BRCA2.csv', index=False)



#%%
# finaloutput.to_csv('/home/jiye/jiye/copycomparison/variantinfo/withsalvage/depth5/WGS_RNA_BRCA2.csv', index=False)
...
def makedf(i):
    wgs_AF = pd.read_csv('~/jiye/copycomparison/newdata/new_WGS_BRCA2/final-BRCA2-' + filelist.iloc[i,1], sep='\t', header=None, on_bad_lines='skip')
...
#%%
finaloutput.to_csv('/home/jiye/jiye/copycomparison/variantinfo/withsalvage/depth10/WGS_RNA_BRCA2.csv', index=False)


#%%
#finaloutput.to_csv('/home/jiye/jiye/copycomparison/variantinfo/WGS_RNA_BRCA2.csv', index=False)
