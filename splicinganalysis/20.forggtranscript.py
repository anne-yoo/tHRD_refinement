...
# %%
brip = pd.read_csv('/home/jiye/jiye/copycomparison/OC_transcriptome/annotation/gffread/BRIP1.gtf', sep='\t', header=None)
...
#%%
brip = brip.loc[(brip['transcript_name']=='ENST00000259008.2') | (brip['transcript_name']=='MSTRG.49834.247'),:]
# %%
brip.to_csv('/home/jiye/jiye/copycomparison/OC_transcriptome/annotation/gffread/BRIP1_only2.gtf', sep='\t',index=False, header=True)



# %%
degfile = pd.read_csv('/home/hyeongu/DATA5/hyeongu/YUHS_transfer_data/data/readcount/final_data/DSG_DEG_comp/DEG_p5.txt', sep='\t')
deglist = set(degfile['1'])
...
# %%
####* for DEXSeq input ###
gtf = pd.read_csv('/home/jiye/jiye/copycomparison/OC_transcriptome/annotation/merged.gtf', sep='\t', skiprows=2, on_bad_lines='skip', header=None)
# %%
gtf.columns = ['chr','tool','type','start','end','qual','strand','dunno','memo']

# %%
f_gtf = gtf[gtf['strand']!='.']

# %%
f_gtf.to_csv('/home/jiye/jiye/copycomparison/OC_transcriptome/annotation/filtered.gtf', sep='\t', header=None,  index=None, quoting=3)
# %%

###* for DEXSeq input 22 -> only BRIP1###
gtf = pd.read_csv('/home/jiye/jiye/copycomparison/OC_transcriptome/annotation/BRIP1.gtf', sep='\t', skiprows=2, on_bad_lines='skip', header=None)
gtf.columns = ['chr','tool','type','start','end','qual','strand','dunno','memo']
f_gtf = gtf[gtf['strand']!='.']
f_gtf.to_csv('/home/jiye/jiye/copycomparison/OC_transcriptome/annotation/filtered_BRIP1.gtf', sep='\t', header=None,  index=None, quoting=3)
