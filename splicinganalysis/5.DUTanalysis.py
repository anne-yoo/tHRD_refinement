...
# %%
#^ feature gene list
features = pd.read_csv("/home/hyeongu/DATA5/hyeongu/YUHS_transfer_data/data/pre_post_TU/final_data/MW_result/MW_removed_NR_stable_diff.txt", sep='\t')
# features = pd.read_csv("/home/hyeongu/DATA5/hyeongu/YUHS_transfer_data/data/pre_post_TU/final_data/MW_result/MW_RES_INT_stable_diff.txt", sep='\t')
features = pd.DataFrame(features.iloc[:,0])
...
# %%
#^ tu data download
# tu = pd.read_csv("/home/hyeongu/DATA5/hyeongu/YUHS_transfer_data/data/pre_post_TU/final_data/major_prop.txt", sep='\t') #* major
tu = pd.read_csv("/home/hyeongu/DATA5/hyeongu/YUHS_transfer_data/data/pre_post_TU/final_data/minor_prop.txt", sep='\t') #* minor
...
res_int = clinical[clinical['group']==0] #* responder / non-responder
...
print("minor TU: pre < post - ", final.shape[0], "transcripts")
...
#%%
#&#########################################################################################################
#^ minor transcripts -> gene match x real transcripts only
#^ feature gene list
features = pd.read_csv("/home/hyeongu/DATA5/hyeongu/YUHS_transfer_data/data/pre_post_TU/final_data/MW_result/MW_removed_NR_stable_diff.txt", sep='\t')
# features = pd.read_csv("/home/hyeongu/DATA5/hyeongu/YUHS_transfer_data/data/pre_post_TU/final_data/MW_result/MW_RES_INT_stable_diff.txt", sep='\t')
features = pd.DataFrame(features.iloc[:,0])
...
samplenum = final_tu.shape[1]-2
mw_test['gene_ENST'] = final_tu.iloc[:num,-1].to_list()
mw_test['p-val'] = 0

for i in range(num):
    list_a = final_tu.iloc[i,:samplenum]
    list_b = final_tu.iloc[i+45,:samplenum]
