...
import random
random_terms = random.sample(terms, 200)
...
for term in go_term_ids:
    ...
    if input.shape[0]>0:
        ...
        def plot_feature_importances(model, feature_names, top_n=30):
            ...
            plt.ylabel('Features')
            #plt.savefig('/home/jiye/jiye/copycomparison/gDUTresearch/202403_analysis/model/model1_random/'+term+'_FI.pdf', bbox_inches="tight")
            plt.close()
        ...
        def plot_confusion_matrix(y_true, y_pred_prob, threshold=0.5):
            ...
            #plt.savefig('/home/jiye/jiye/copycomparison/gDUTresearch/202403_analysis/model/model1_random/'+term+'_CM.pdf', bbox_inches="tight")
            plt.close()

        ####^^ iterate 100 times ####
        
        # Split the dataset into training and testing sets
        X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.3, random_state=randomseed, stratify=y)
        ...
        #plt.tight_layout()
        plt.savefig('/home/jiye/jiye/copycomparison/gDUTresearch/202403_analysis/model/model1_random/'+term+'_curves.pdf', bbox_inches="tight")
        plt.close()
        ...
        with open('/home/jiye/jiye/copycomparison/gDUTresearch/202403_analysis/model/model1_random/result/'+term+'_result.txt', 'w') as file:
...
# %%
####^^^^^ READ THE RESULTS #######
model1_result = pd.read_csv('/home/jiye/jiye/copycomparison/gDUTresearch/202403_analysis/model/model1_random/result/combined_results.csv', sep=',')
...
medians = df_melted.groupby(['Metric'])['Value'].median() #### median
...
#sns.despine()
# %%
topgo = model1_result[(model1_result['train_rocauc']>0.8) & (model1_result['test_rocauc']>0.8) & (model1_result['train_prauc']>0.8) & (model1_result['test_prauc']>0.8)]
