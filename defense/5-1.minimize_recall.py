...
param_grid = {
    ...
    'class_weight': ['balanced', dict_weight]
}
...
#    plt.savefig('/home/jiye/jiye/copycomparison/gDUTresearch/forDefense/val/new_fig3d_F1score_'+str(nums)+'.pdf', )
    plt.show()
...
best_params =  {'bootstrap': True, 'class_weight':{0: 2.17, 1: 1},'max_depth': 50, 'max_features': 'auto', 'min_samples_leaf': 2, 'min_samples_split': 2, 'n_estimators': 100}
