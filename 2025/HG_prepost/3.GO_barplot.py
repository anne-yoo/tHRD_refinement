...
results = pd.read_csv('/home/jiye/jiye/copycomparison/GENCODEquant/SEV_prepost/merged_cov5_analysis/maintenance/AR_stable_DUT_Wilcoxon_delta_withna.txt', sep='\t')
#results = results[(results['p_value']<0.01)]

### up-regulated vs. down-regulated ??###
results = results[(results['p_value']<0.05) & (np.abs(results['delta_TU'])>0.02)]
...
plt.savefig('/home/jiye/jiye/copycomparison/GENCODEquant/SEV_prepost/merged_cov5_analysis/maintenance/delta002_DUT_GOenrichment.pdf', dpi=300, bbox_inches='tight')
plt.show()
## %%
