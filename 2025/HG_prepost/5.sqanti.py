...
plt.xlim(0, 15000)
sns.despine()
plt.savefig('/home/jiye/jiye/copycomparison/GENCODEquant/SEV_prepost/sqantioutput/figures/length_histogram.pdf', bbox_inches='tight', dpi=300)
plt.show()
...
plt.ylim(0, 15000)
sns.despine()
plt.savefig('/home/jiye/jiye/copycomparison/GENCODEquant/SEV_prepost/sqantioutput/figures/length_boxplot.pdf', bbox_inches='tight', dpi=300)
plt.show()
...
plt.xlim(0, 40)
sns.despine()
plt.savefig('/home/jiye/jiye/copycomparison/GENCODEquant/SEV_prepost/sqantioutput/figures/exon_histogram.pdf', bbox_inches='tight', dpi=300)
plt.show()
...
plt.ylim(0, 30)
sns.despine()
plt.savefig('/home/jiye/jiye/copycomparison/GENCODEquant/SEV_prepost/sqantioutput/figures/exon_boxplot.pdf', bbox_inches='tight', dpi=300)
plt.show()
...
plt.savefig('/home/jiye/jiye/copycomparison/GENCODEquant/SEV_prepost/sqantioutput/figures/category_barplot.pdf', bbox_inches='tight', dpi=300)
plt.show()
...
plt.xlabel("Count")
plt.ylabel("Structural Category")
plt.savefig('/home/jiye/jiye/copycomparison/GENCODEquant/SEV_prepost/sqantioutput/figures/mstrg_category_barplot.pdf', bbox_inches='tight', dpi=300)
plt.show()
# %%
plt.figure(figsize=(6,4))
sns.countplot(
...
plt.savefig('/home/jiye/jiye/copycomparison/GENCODEquant/SEV_prepost/sqantioutput/figures/subcategory_barplot.pdf', bbox_inches='tight', dpi=300)
plt.show()
...
plt.xlabel("Count")
plt.ylabel("Subcategory")
plt.savefig('/home/jiye/jiye/copycomparison/GENCODEquant/SEV_prepost/sqantioutput/figures/mstrg_subcategory_barplot.pdf', bbox_inches='tight', dpi=300)
plt.show()
# %%
###^^ within CAGE peak ####
...
counts = sqanti[sqanti['isoform'].str.contains('MSTRG')]['coding'].value_counts() #[sqanti['isoform'].str.contains('MSTRG')]
counts = counts.reindex(['coding','non_coding'])
colors = ["#F5AD18", "#9C4170",]
...
for autotext in autotexts:
    autotext.set_fontsize(13)  # 원하는 크기

# label 글자 크기 조절 (선택)
for text in texts:
    text.set_fontsize(13)
plt.savefig('/home/jiye/jiye/copycomparison/GENCODEquant/SEV_prepost/sqantioutput/figures/mstrg_coding_piechart.pdf', bbox_inches='tight', dpi=300)
plt.show()
#%%
...
sampleinfo.index = sampleinfo.index.to_list()
...
for coding_status in ['coding', 'non_coding']: 
    ...
    for group_name in ['AR', 'IR']:
        ...
        #final_genes = set(final_genes).intersection(majorlist_set)
...
def assign_category(row):
    # 조건 1: Coding Major
    if ((row['structural_category'] == "full-splice_match") or (row['structural_category']=="novel_in_catalog")) and (row['coding'] == 'coding') and (row['major'] == True):
        return 'Class 1: Coding Major'
    # 조건 2: Coding Minor
    elif (row['coding'] == 'coding') and (row['major'] == False):
        return 'Class 2: Coding Minor'
    # 조건 3: Non-coding (여기서는 Minor로 간주)
    elif (row['coding'] == 'non_coding') and (row['major'] == False):
        return 'Class 3: Noncoding Minor'
    else:
...
category_colors = {
    'Class 1: Coding Major': '#D62728',  # 빨강 (강조)
    'Class 2: Coding Minor': '#FF7F0E',  # 주황
    'Class 3: Noncoding Minor': '#1F77B4', # 파랑
    '4_Others': 'lightgrey'
}
...
def draw_custom_heatmap(group_name, dut_list, sample_list):
    ...
    print(sort_df['group'].value_counts())
    # 7. 시각화
