...
def filter_protein_coding_genes(combined_df, gencode_gtf):
    coding_genes = set()

    with open(gencode_gtf, 'r') as infile:
        for line in infile:
            if line.startswith("#"):
                continue  # Skip comment lines
            ...
            if len(fields) > 8 and fields[2] == "gene":
                ...
                for attr in attributes:
                    ...
                    if attr.startswith("gene_id"):
                        ...
                        gene_type = attr.split(" ")[1].strip()

                if gene_type == "protein_coding":
                    coding_genes.add(gene_id)

    # Filter combined DataFrame to include only rows with protein-coding genes
    filtered_df = combined_df[combined_df['ensembl_gene_id'].isin(coding_genes)]
    return filtered_df

# Step 1: Extract MSTRG to Ensembl gene mappings from 291_merge.gtf
stringtie_gtf_path = "/home/jiye/jiye/nanopore/2025data/SR_WTS/isoforms_corrected.gtf"
...
# Step 3: Filter for protein-coding genes using the Gencode GTF
gencode_gtf_path = "/home/jiye/jiye/refdata/gencode.v38.annotation.gtf"
filtered_df = filter_protein_coding_genes(combined_df, gencode_gtf_path)

# Save the final filtered DataFrame to a file
filtered_output_path = "/home/jiye/jiye/nanopore/2025data/SR_WTS/filtered_transcripts_with_gene_info.tsv"
filtered_df.to_csv(filtered_output_path, sep='\t', index=False)
print(f"Filtered protein-coding transcripts saved to {filtered_output_path}")
...
# Example usage
base_directory = "/home/sujie/sujie/nanopore/datafromhrs/SR_WTS/quantif_aftsqt/"  # Update with the correct path
matrix_file_path = "/home/jiye/jiye/nanopore/2025data/SR_WTS/filtered_transcripts_with_gene_info.tsv"  # Update with the correct path
tpm_df = build_tpm_matrix_fast(base_directory, matrix_file_path)

# Save the DataFrame to a file
output_file_path = "/home/jiye/jiye/nanopore/2025data/SR_WTS/243_transcript_TPM.txt"  # Update with the desired output path
...
# Example usage
transcript_tpm_matrix_path = "/home/jiye/jiye/nanopore/2025data/SR_WTS/243_transcript_TPM.txt"  # Update with the correct path
matrix_file_path = "/home/jiye/jiye/nanopore/2025data/SR_WTS/filtered_transcripts_with_gene_info.tsv"  # Update with the correct path
output_file_path = "/home/jiye/jiye/nanopore/2025data/SR_WTS/243_gene_TPM.txt"  # Update with the desired output path
...
# Example usage
input_file = "/home/jiye/jiye/nanopore/FINALDATA/291_gene_TPM.txt"  # Update with the correct path
output_file = "/home/jiye/jiye/nanopore/FINALDATA/matched_gene_TPM.txt"  # Update with the desired output path
...
# Example usage
transcript_tpm_file = "/home/jiye/jiye/nanopore/FINALDATA/291_transcript_TPM.txt"  # Update with the correct path
paired_gene_exp_file = "/home/jiye/jiye/nanopore/FINALDATA/matched_gene_TPM.txt"  # Use the output from previous step
output_file = "/home/jiye/jiye/nanopore/FINALDATA/matched_transcript_TPM.txt"  # Update with the desired output path
filter_transcript_tpm_matrix(transcript_tpm_file, paired_gene_exp_file, output_file)

# %%
aa = pd.read_csv("/home/jiye/jiye/nanopore/FINALDATA/matched_transcript_TPM.txt", sep='\t')
bb = pd.read_csv("/home/jiye/jiye/nanopore/FINALDATA/matched_gene_TPM.txt", sep='\t')
...
tpm_matrix_file = "/home/jiye/jiye/nanopore/FINALDATA/matched_transcript_TPM.txt"  # Replace with actual file path
transcript_info_file = "/home/jiye/jiye/nanopore/gtfcompare/stringtiesample/filtered_transcripts_with_gene_info.tsv"  # File containing transcript_id and gene_name mapping
output_file ="/home/jiye/jiye/nanopore/FINALDATA/matched_transcript_readcount.txt" # Output file
...
tpm_matrix_file = "/home/jiye/jiye/nanopore/FINALDATA/matched_gene_TPM.txt"  # Replace with actual file path
output_file = "/home/jiye/jiye/nanopore/FINALDATA/matched_gene_readcount.txt"  # Output file
...
readcount_df = pd.read_csv("/home/jiye/jiye/nanopore/FINALDATA/matched_gene_readcount.txt", sep='\t')  # Replace with your actual file path
readcount_df = drop_smaller_mean_duplicates(readcount_df)

# Save the cleaned DataFrame if needed
readcount_df.to_csv("/home/jiye/jiye/nanopore/FINALDATA/cleaned_matched_gene_readcount.txt", index=False, sep='\t')
...
generead = pd.read_csv("/home/jiye/jiye/nanopore/FINALDATA/matched_gene_readcount.txt", sep='\t', index_col=0)
clinlist = set(clin.index.to_list())
readlist = set(generead.columns.str[:-2].to_list())

#%%
gene_readcount = pd.read_csv("/home/jiye/jiye/nanopore/FINALDATA/matched_gene_readcount.txt", sep='\t', index_col=0)
gene_tpm = pd.read_csv("/home/jiye/jiye/nanopore/FINALDATA/matched_gene_TPM.txt", sep='\t', index_col=0)
trans_readcount = pd.read_csv("/home/jiye/jiye/nanopore/FINALDATA/matched_transcript_readcount.txt", sep='\t', index_col=0)
trans_tpm = pd.read_csv("/home/jiye/jiye/nanopore/FINALDATA/matched_transcript_TPM.txt", sep='\t', index_col=0)
...
gene_readcount.to_csv("/home/jiye/jiye/nanopore/FINALDATA/137_gene_readcount.txt", sep='\t', index=True)
gene_tpm.to_csv("/home/jiye/jiye/nanopore/FINALDATA/137_gene_TPM.txt", sep='\t', index=True)
trans_readcount.to_csv("/home/jiye/jiye/nanopore/FINALDATA/137_transcript_readcount.txt", sep='\t', index=True)
trans_tpm.to_csv("/home/jiye/jiye/nanopore/FINALDATA/137_transcript_TPM.txt", sep='\t', index=True)
